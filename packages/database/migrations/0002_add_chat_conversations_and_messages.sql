...
CREATE UNIQUE INDEX "conversation_reads_conversation_id_user_id_unique" ON "conversation_reads" USING btree ("conversation_id","user_id");--> statement-breakpoint
CREATE INDEX "conversation_reads_user_id_index" ON "conversation_reads" USING btree ("user_id");--> statement-breakpoint
...
CREATE UNIQUE INDEX "message_reactions_message_id_user_id_emoji_unique" ON "message_reactions" USING btree ("message_id","user_id","emoji");--> statement-breakpoint
CREATE UNIQUE INDEX "message_reads_message_id_user_id_unique" ON "message_reads" USING btree ("message_id","user_id");--> statement-breakpoint
CREATE INDEX "message_reads_user_id_index" ON "message_reads" USING btree ("user_id");