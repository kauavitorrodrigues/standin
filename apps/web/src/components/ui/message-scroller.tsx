...
function MessageScrollerViewport({
    ...
    return (
        <MessageScrollerPrimitive.Viewport
            ...
            className={cn(
                // No bottom fade: it's driven by a scroll animation-timeline
                // measured against scrollHeight, which includes this
                // component's own hidden spacer element. In a chat where the
                // newest message always sits at the very bottom, that
